...
{
    public partial class SearchPatientInfoNurse : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PatientDetailsNurse.aspx?PatientID=" + searchPatient.SelectedDataKey.Value.ToString());
