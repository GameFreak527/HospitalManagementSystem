<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="UpdateReportPage.aspx.cs" Inherits="Hospital_Management_System.UpdateReportPage" %>
...
&nbsp;<asp:TextBox ID="PrescriptionTextBox" runat="server"></asp:TextBox>
    ...
    <br />
    <br />
    <asp:Button ID="Button1" runat="server" Text="Update Medical Report" OnClick="Button1_Click" />
</asp:Content>
